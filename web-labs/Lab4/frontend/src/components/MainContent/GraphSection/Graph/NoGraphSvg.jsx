...
const NoGraphSvg = (props) => {
  return (
    <svg width="220" height="220" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x={43 - (-props.rValue / 1).toString().length * 3} y="100" fontSize="14">{-props.rValue}</text>
      ...
      <text x={176 - (props.rValue / 1).toString().length * 3} y="100" fontSize="14">{props.rValue / 1}</text>

      {/* Y-Axis coordinates */}
      <line x1="105" y1="176" x2="115" y2="176" stroke="black" />
      <text x="120" y="181" fontSize="14">{-props.rValue / 1}</text>
      ...
      <text x="120" y="48" fontSize="14">{props.rValue / 1}</text>
    </svg>
  );
}

export default NoGraphSvg;
