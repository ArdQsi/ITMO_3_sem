...
const GraphSvg = (props) => {
  return (
    <svg width="220" height="220" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x={176 - (props.rValue[0]).toString().length * 3} y="100" fontSize="14">{props.rValue[0] / 1}</text>

      {/* Y-Axis coordinates */}
      <line x1="105" y1="176" x2="115" y2="176" stroke="black" />
      <text x="120" y="181" fontSize="14">{-props.rValue[0] / 1}</text>
      ...
      <text x="120" y="48" fontSize="14">{props.rValue[0] / 1}</text>

      {/* Triangle */}
      <polygon points="43,110 110,110 110,43"
               fill="blue" fillOpacity="0.25" stroke="darkblue" strokeOpacity="0.5" />

      {/* Rectangle */}
      <polygon points="76,110 76,176 110,176 110,110"
               fill="green" fillOpacity="0.25" stroke="darkgreen" strokeOpacity="0.5" />

      {/* Circle */}
      <path d="M 143 110 A 33 33 0 0 1 110 143 L 110 110 Z"
