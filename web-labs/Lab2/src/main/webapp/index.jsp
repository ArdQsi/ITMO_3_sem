...
<%--                                    <object class="result-graph" type="image/svg+xml" data="img/Frame 2.svg"></object>--%>



<%--    <canvas id="chart" height="602px" width="602px"></canvas>--%>
                        <svg id = "picture" width="300" height="300" viewBox="0 0 258 260" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M126.514 130C126.514 130 126.514 130 126.514 230.788C69.9048 230.788 28.5 186.609 28.5 130C74.486 130 69.9048 130 126.514 130C33.5 130 183.123 130 126.514 130Z" fill="#0F0AF5" fill-opacity="0.5"/>
                            ...
                            <path d="M131.384 6.09091H132.896L135.922 11.1832H136.05L139.075 6.09091H140.588L136.646 12.5043V17H135.325V12.5043L131.384 6.09091Z" fill="black"/>
                        </svg>
                    </div>
                </section>
                ...
                <section class="main_container_item content-values">
                    ...
                    <form id="picture_form" action="servlets.ControllerServlet" method="get"></form>
                    <form class="input_form" action="servlets.ControllerServlet" method="GET">
                        ...
                        <div class="input-form__button">
                            ...
                            <button class="input-form_button_reset"
